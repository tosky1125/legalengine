...
var mapIds = function (data, keyName) { return (Array.isArray(data) ? data : []).map(function (value) { return appendId(value, keyName); }); };
var useFieldArray = function (_a) {
    ...
    var append = function (value, shouldFocus) {
        ...
        var updateFormValues = __spread(allFields.current, (Array.isArray(value)
    ...
    var prepend$1 = function (value, shouldFocus) {
        ...
        var updatedFieldArrayValues = prepend(getCurrentFieldsValues(), Array.isArray(value)
            ? appendValueWithKey(value)
            : [appendId(value, keyName)]);
    ...
    var insert$1 = function (index, value, shouldFocus) {
        ...
        var emptyArray = fillEmptyArray(value);
        var fieldValues = getCurrentFieldsValues();
        var updatedFieldArrayValues = insert(fieldValues, index, Array.isArray(value)
            ? appendValueWithKey(value)
            : [appendId(value, keyName)]);
        setFieldAndValidState(updatedFieldArrayValues);
        resetFields();
