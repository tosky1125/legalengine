...
// );
// console.log(test.replace(/null/g,''));

var test2 = diffString(
  '③ 구급대원은 구급활동 중 심폐정지환자에게 심폐소생술이나 심장충격기를 이용한 응급처치를 한 경우에는 별지 제6호서식의 심폐정지환자 응급처치 세부 상황표를 작성하여 소속 소방관서에 3년간 보관하여야 한다.',
...
console.table(test2.replace(/null/g,''));
